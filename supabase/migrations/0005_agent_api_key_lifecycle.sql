-- 0005_agent_api_key_lifecycle.sql
...
create table public.agent_auth_failures (
...
create index agent_auth_failures_key_window_idx
  on public.agent_auth_failures (key_id, created_at desc);

create index agent_auth_failures_created_at_idx
...
create index agent_logs_team_created_at_idx
  on public.agent_logs (team_id, created_at desc);

create index agent_logs_member_created_at_idx
