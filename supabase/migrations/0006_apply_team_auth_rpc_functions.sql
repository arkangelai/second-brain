-- 0006_apply_team_auth_rpc_functions.sql
-- Re-applies the team auth RPC layer under a new migration version.
-- The remote project already recorded 0005 before these RPC definitions were
-- added locally, so this migration makes Supabase pick up the current schema.
